...
func main() {
	...
	protected.HandleFunc("/api/invites/{id}/accept", (handlers.AcceptInvite)).Methods("POST")
	protected.HandleFunc("/api/invites/{id}/decline", (handlers.DeclineInvite)).Methods("POST")
